		...
		<div>
			...
			<div class="container">
                ...
                <!-- <tr>
                	...
                	$total_el = 0;
                	$total_esil = 0;
      $current = strtotime('2023-04-1');
      $date2 = strtotime('2024-03-1');
      $stepVal = '+1 month';
      while( $current <= $date2 ) {
                            ...
                            if(isset($result)) {
                                foreach($result as $res){
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><?php echo floor($a->GROSS * (3.25/100)); $total_esi1 += floor($a->GROSS * (3.25/100));  ?></td>
                                        <td style="text-align: right;"><?php echo floor($a->GROSS * (0.75/100)); $total_esi2 += floor($a->GROSS * (0.75/100));  ?></td>
                                    </tr>
                                    <?php
                                }}
                                ?>
                ...
                <tbody>
                    ...
                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        $total_BASIC1 += $r->BASIC1; $total_BASIC11 += $r->BASIC1;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->DA1, 2);
                                        $total_DA1 += $r->DA1; $total_DA11 += $r->DA1;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->HRA, 2);
                                        $total_HRA11 += $r->HRA; $total_HRA111 += $r->HRA;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->CONV, 2);
                                        $total_CONV11 += $r->CONV; $total_CONV111 += $r->CONV;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->MED, 2);
                                        $total_OA11 += $r->OA; $total_OA111 += $r->MED;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->GROSS, 2);
                                        $total_TOTAL1 += $r->GROSS; $total_TOTAL11 += $r->GROSS;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->BASIC2, 2);
                                        $total_BASIC2 += $r->BASIC2; $total_BASIC21 += $r->BASIC2;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->DA2, 2);
                                        $total_DA2 += $r->DA2; $total_DA21 += $r->DA2;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->HRA, 2);
                                        $total_HRA12 += $r->HRA; $total_HRA121 += $r->HRA;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->CONV, 2);
                                        $total_CONV12 += $r->CONV; $total_CONV121 += $r->CONV;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->MED, 2);
                                        $total_OA12 += $r->OA; $total_OA121 += $r->MED;
                                        ?></td>
                                        <td style="text-align: right;"><?php echo number_format((float)$r->GROSS, 2);
                                        $total_TOTAL22 += $r->GROSS; $total_TOTAL221 += $r->GROSS;
                                        ?></td>
                                        ...
                                        $total_INS += $r->INS; $total_INS1 += $r->INS;
                                        ?></td>
			...
			<div class="container" style="margin-top: 8px;"/>
				<div class="row mar_bot_3" style="width: 400mm; margin-left: 23px;">
					<div class="col-sm-12 border_all text-center">
						...
						<h4 class="mar_0">51, MAHANIRBAN ROAD, KOLKATA - 700 029</h4>
						<h4 class="mar_0">
					...
					<div class="container">
						<div class="row">
							<div class="table-responsive">
							    ...
							    <tbody>
                                <tr>
                                    <th style="text-align: center;"><b>NAME OF EMPLOYEE- এমপলয়ী নাম</b></th>
...
?></b></td>
                                    ...
                                    <td style="text-align: center;">CONV  <br/> কনভেয়ানস </td>
                                ...
                                <tr>
                                    <td></td>
                                    <td style="text-align: center;"><b> CONVENCE <br/> কনভেয়ানস </b></td>
                ...
                $current = strtotime('2023-04-01');
                //   $date2 = strtotime('2023-03-01');
                if($wordArray[2] < 4 || $wordArray[2] == 12) {
                   $date2 = strtotime(date('Y').'-' . $mn . '-01'); 
                } else {
                  $date2 = strtotime('2023-' . $mn . '-01');  
                }
                if($wordArray[2] < 4 || $wordArray[2] == 12) {
                $date_prev = strtotime('2023-' . '01' . '-01');     
                } else if($wordArray[2] == 1) {
                $date_prev = strtotime('2023-' . $mn_prev . '-01');
                }else {
                $date_prev = strtotime('2023-' . $mn_prev . '-01');    
                }
                $stepVal = '+1 month';
...
?>
                                    ...
                                    <td style="text-align: center;"><b>LEAVE ALLOW <br/>  লিভ অলোয়াড </b></td>
                                    <?php if ($result->el_granted == 0)
                { ?>
...
?>
                ...
                //Opening date of portal (default 2022-04-01)
                $current_sal = strtotime('2023-04-01');
                $dates_sal = array();
                $dates1_sal = array();
                //$date2 = strtotime('2023-03-01');
                ...
                if($array_sal[2] < 4 || $array_sal[2] == 12) {
                   $date2_sal = strtotime(date('Y').'-' . $mn . '-01'); 
                } else {
                  $date2_sal = strtotime('2023-' . $mn . '-01');  
                }
        ...
        ORDER BY advance.date desc";
                ...
                $total_advance_taken = $this
                    ...
                    ->row()->amount;
?>
                                    <td colspan="2" style="text-align: center;"><b>TOTAL ADVANCE TAKEN <br/> মোট অ্যাডভানস </b></td>
                                    <?php if ($salary_details_advn_advc_value > 0)  // $result->LOAN > 0 or $salary_details_advn_advc_value > 0
                { ?>
                                    <td style="text-align: center; font-size: 16px;"><b><?=$salary_details_advn_advc_value?></b></td>
                                    <?php
                }
                else
                { ?>
                                    ...
                                    <?php if ($salary_details_advn_advc_value > 0)  //or $salary_details_advn_advc_value > 0
                { ?>
