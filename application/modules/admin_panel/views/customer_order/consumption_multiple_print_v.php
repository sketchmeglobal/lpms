                    ...
                    <div class="row">
                        ...
                        <table id="" class="table table-bordered table-hover width-100 table2excel consumption_table" >
                                ...
                                foreach ($consumption as $f) {
                                    $key = ($f->item_name.'-'.$f->leather_color);
                                    if (!isset($groups[$key])) {
                                        $groups[$key] = array(
                                            'item_name' => $f->item_name.'-'.$f->leather_color,
                                            'item_color' => $f->item_color,
                                            'final_qnty' => $f->final_qnty,
                                        );
                                    } else {
                                        $groups[$key]['item_name'] = $f->item_name.'-'.$f->leather_color;
                                ...
                                // echo '<pre>', print_r($groups), '</pre>';die();
                                    ...
                                    foreach($consumption as $key=>$val) {
                                        if (($val->item_name.'-'.$val->leather_color) == ($con->item_name.'-'.$con->leather_color)) {
                                            array_push($keys, $key);
                                        }
                                    }
                        ...
                        <table id="" class="table table-bordered table-hover width-100 table2excel consumption_table" >
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $con->co_no ?></td>
                                            <!--########### SUPER_FINAL_QNTY changed to FINAL_QNTY ########### ON 070821 BY SAYAK - VERIFICATION AWAITING...-->
                                    ...
                                    if(end($keys) == $curr_key) {
                                        ?>
                                        <tr>
                                            <th colspan="4">Total for <?=$con->item_name?>[<?= $con->leather_color ?>]</th>
                                            <th style="text-align: right;"><?= number_format( $groups[$con->item_name.'-'.$con->leather_color]['final_qnty'], 2)?></th>
                                        </tr>
                                        <?php
                                    }
                                ?>
