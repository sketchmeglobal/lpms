...
//die;
$tot_qnty_q = 0;
foreach ($jobber_issue_details as $fa) {
    $tot_qnty_q += $fa->jobber_issue_quantity;
}
?>
...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title> Jobber Issue Challan Print | <?=WEBSITE_NAME;?></title>
    ...
    <!-- Set also "landscape" if you need -->
    <?php if(count($jobber_issue_details) > 0) { ?>
            ...
            <div>
                ...
                <div class="container">
                    <div class="row border_all text-center text-uppercase mar_bot_3">
                        <h3 class="mar_0 head_font">Jobber Issue Challan</h3>
                    </div>
                    <div class="row mar_bot_3">
                        ...
                        <div class="col-sm-6 header_right">
                            <div class="row mar_bot_3">
                                <div class="col-sm-5 border_all height_80">
                                    <div class="">
                                        ...
                                        <h4 class="mar_0"><strong><?= $jobber_issue_details[0]->jobber_challan_number ?></strong></h4>
                                        <h6 class="mar_0"><strong>(<?= $jobber_issue_details[0]->jobber_issue_date ?>)</strong></h6>
                                    </div>
                                </div>
                                <div class="col-sm-7 border_all height_80">
                                    <div class="">
                                        <p class="mar_0">Issued To: <b><?= $jobber_issue_details[0]->acc_name . ' ' ?></b></p>
                                        <p class="mar_0">
                                             (<?= $jobber_issue_details[0]->acc_address ?>)
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row border_all height_21">
                                <div class="col-sm-12">
                                    <p class="mar_0">Exp. Date of Delv. : <strong><?= $jobber_issue_details[0]->jobber_expected_delivery_date ?></strong></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover width-100 table2excel" >
                                ...
                                <tbody>
                                    ...
                                    $tot_qnty = 0;
                                    $tot_amnt = 0;
                                    foreach ($jobber_issue_details as $ppl) {
                            ...
                            <div class="row">
                                <footer>
                                    ...
                                    <div class="col-sm-6 border_all height_135">
                                        <p class="mar_0">Signature & Date</p>
                                        <h6 class="mar_0 text-uppercase"><strong>For, <?= $jobber_issue_details[0]->acc_name ?></strong></h6>
                                        <br />
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="">
                    ...
                    <div class="container">
                        <div class="">
                                ...
                                <div class="col-sm-6 header_right">
                                    <div class="row mar_bot_3">
                                        <div class="col-sm-6 border_all height_60">
                                            <div class="">
                                                <p class="mar_0">Challan No. & Date</p>
                                                <h5 class="mar_0"><strong><?= $jobber_issue_details[0]->jobber_challan_number ?></strong></h5>
                                                <h6 class="mar_0"><strong>(<?= $jobber_issue_details[0]->jobber_issue_date ?>)</strong></h6>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 border_all height_60">
                                            <div class="">
                                                ...
                                                <p class="mar_0"><b><?= $jobber_issue_details[0]->acc_name ?></b></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row border_all height_63 mar_bot_3">
                                    ...
                                    <div class="row border_all height_21">
                                        <div class="col-sm-12">
                                            <p class="mar_0">Expected Date : <strong><?= $jobber_issue_details[0]->jobber_expected_delivery_date ?></strong></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row table-responsive">
                                <table class="table table-bordered table-hover table2excel" style="font-size: 12px;">
                                    <thead>
                                        <tr>
                                            <th>Order No.</th>
                                            <th>Article</th>
                                    ...
                                    ?>
                                    <tr>
                                        <td nowrap style="font-size: 12px;"><?= $ppl->co_no ?></td>
                                        <td style="font-size: 12px;"><?= $ppl->art_no . '~' . $ppl->info .' ['. $ppl->leather_color .']' ?></td>
                                        <td class="text-right"  style="font-size: 13px;"><?= round($ppl->jobber_issue_quantity, 2) ?></td>
                                        <td style="font-size: 12px;"><?= $ppl->jobber_emboss ?></td>
                                    </tr>
...
//                                echo 'td to be added. =>' . $add_td;die;
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><?= $tot_qnty_q ?></td>
                                    <td></td>
                                </tr>
                        ...
                        <table id="consumption_table" class="table table-hover table-striped table-responsive" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th>Quantity</th>
                                    <th>Unit</th>
                                    <th nowrap>lth colour</th>
                                    <th nowrap>fit colour</th>
                                    <th nowrap>Item colour</th>
                                </tr>
                            </thead>
                                    ...
                                    foreach($result as $key=>$val) {
                                        if ($val->item_name == $con->item_name) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $con->unit ?></td>
                                                <td nowrap><?= $con->lth_color ?></td>
                                                <td nowrap><?= $con->fit_color ?></td>   
                                                <td nowrap><?= $con->item_color ?></td>   
                                            </tr>
                                            <?php
