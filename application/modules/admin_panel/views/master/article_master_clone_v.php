...
<html lang="en">
<head>
    <title> Article Clone | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Article Clone</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active">Article Clone</li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
        ...
        <div class="wrapper">
            ...
            <section class="panel text-center">
                <button type="submit" form="form_edit_article_master_clone" class="btn btn-warning"><i class="fa fa-clone"> Clone Article Master</i></button>
            </section>
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form id="form_edit_article_master_clone" method="post" action="<?=base_url('admin/form_edit_article_master_clone')?>" enctype="multipart/form-data" class="cmxform form-horizontal tasi-form">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-4">
                                        <input id="art_no" name="art_no" value="" type="text" placeholder="Article Number" required class="form-control round-input" />
                                    </div>

                                    <label for="alt_art_no" class="control-label col-lg-2">Alternate Article No</label>
                                    <div class="col-lg-4">
                                        <input id="alt_art_no" name="alt_art_no" value="" type="text" placeholder="Alternate Article Number" class="form-control round-input" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <label for="alter_score" class="control-label col-lg-2">Alter/Rejection Score</label>
                                    <div class="col-lg-2">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="color_add" class="tab-pane fade">
                                    <br/>
                                    <div class="form">
                                        <form id="form_add_article_color_clone" method="post" action="<?=base_url('admin/form_add_article_color_clone')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                                ...
                                <div id="color_edit" class="tab-pane fade">
                                    <br/>
                                    <div class="form">
                                        <form id="form_edit_article_color_clone" method="post" action="<?=base_url('admin/form_edit_article_color_clone')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <label for="img_color_edit" class="control-label col-lg-2">Image</label>
                                                <div class="col-lg-4">
                                                    <input type="file" id="img_color_edit" name="img_color" accept=".jpg,.jpeg,.png" class="file" >
                                                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="part_add" class="tab-pane fade">
                                    <br/>
                                    <div class="form">
                                        <form id="form_add_article_part_clone" method="post" action="<?=base_url('admin/form_add_article_part_clone')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                                ...
                                <div id="part_edit" class="tab-pane fade">
                                    <br/>
                                    <div class="form">
                                        <form id="form_edit_article_part_clone" method="post" action="<?=base_url('admin/form_edit_article_part_clone')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div id="rate_list" class="tab-pane fade in active">
                                    <table id="article_rate_table" class="table data-table dataTable">
                                        ...
                                        <tr>
                                            <th>Date</th>
                                            <th>Main Remark</th>
                                            <th>Final Ex-Works (Foreign)</th>
                                            <th>Final C & F (Foreign)</th>
                                            <th>Final F.O.B (Foreign)</th>
                                            <th>Status</th>
                                            <th>Actions</th>
                                        </tr>
                                        </thead>
                                ...
                                <div id="rate_add" class="tab-pane fade">
                                    <br/>
                                    <div class="form">
                                        <form id="form_add_article_rate_clone" method="post" action="<?=base_url('admin/form_add_article_rate_clone')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-lg-2">
                                                    <input id="exworks_factory" name="exworks_factory" type="number" min="0" placeholder="Factory ex-works" class="form-control round-input" value="<?=$article->exworks_amt?>" />
                                                </div>

                                                <label for="cf_factory" class="control-label col-lg-2">Factory C & F (INR)</label>
                                                <div class="col-lg-2">
                                                    <input id="cf_factory" name="cf_factory" type="number" min="0" placeholder="Factory C & F" class="form-control round-input" value="<?=$article->cf_amt?>" />
                                                </div>
                                                <label for="fob_factory" class="control-label col-lg-2">Factory F.O.B (INR)</label>
                                                <div class="col-lg-2">
                                                    <input id="fob_factory" name="fob_factory" type="number" min="0" placeholder="Factory F.O.B" class="form-control round-input" value="<?=$article->cf_amt?>" />
                                                </div>
                                            </div>
                                ...
                                <div id="rate_edit" class="tab-pane fade">
                                    <br/>
                                    <div class="form">
                                        <form id="form_edit_article_rate_clone" method="post" action="<?=base_url('admin/form_edit_article_rate_clone')?>" class="cmxform form-horizontal tasi-form">
                                            <div class="form-group ">
...
<script>
    $(document).ready(function() {
        $('#article_color_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('ajax_article_color_table_data_clone')?>",
                "type": "POST",
                "dataType": "json",
                data: {
                    article_id: function () {
        ...
        $('#article_part_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('ajax_article_part_table_data_clone')?>",
                "type": "POST",
                "dataType": "json",
                data: {
                    article_id: function () {
        ...
        $('#article_rate_table').DataTable( {
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?=base_url('ajax_article_rate_table_data_clone')?>",
                "type": "POST",
                "dataType": "json",
                data: {
                    article_id: function () {
    ...
    $("#form_edit_article_master_clone").validate({
        rules: {
            art_no: {
                required: true,
                remote: {
    ...
    $('#form_edit_article_master_clone').ajaxForm({
        beforeSubmit: function () {
            return $("#form_edit_article_master_clone").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
    ...
    $("#form_add_article_color_clone").validate({
        rules: {
            lth_color_id: {
                required: true,
                remote: {
    ...
    $('#form_add_article_color_clone').ajaxForm({
        beforeSubmit: function () {
            return $("#form_add_article_color_clone").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
            obj = JSON.parse(returnData);
            ...
            $('#form_add_article_color_clone :radio').iCheck('update'); //reset all iCheck fields
    ...
    $("#form_edit_article_color_clone").validate({
        rules: {
            lth_color_id: {
                required: true,
                remote: {
    ...
    $('#form_edit_article_color_clone').ajaxForm({
        beforeSubmit: function () {
            return $("#form_edit_article_color_clone").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
            obj = JSON.parse(returnData);
    ...
    $("#article_color_table").on('click', '.article_dtl_edit_btn', function() {
        ...
        $.ajax({
            url: "<?= base_url('ajax_fetch_article_color_clone') ?>",
            method: "post",
            dataType: 'json',
    ...
    $("#form_add_article_part_clone").validate({
        rules: {
            ig_id: {
                required: true,
                remote: {
    ...
    $('#form_add_article_part_clone').ajaxForm({
        beforeSubmit: function () {
            return $("#form_add_article_part_clone").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
            obj = JSON.parse(returnData);

            $('#form_add_article_part_clone')[0].reset(); //reset form
            $("#form_add_article_part_clone select").select2("val", ""); //reset all select2 fields
            $('#form_add_article_part_clone :radio').iCheck('update'); //reset all iCheck fields
            $("#form_add_article_part_clone").validate().resetForm(); //reset validation
            notification(obj);
    ...
    $("#form_edit_article_part_clone").validate({
        rules: {
            ig_id: {
                required: true,
                remote: {
    ...
    $('#form_edit_article_part_clone').ajaxForm({
        beforeSubmit: function () {
            return $("#form_edit_article_part_clone").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
            obj = JSON.parse(returnData);
    ...
    $("#article_part_table").on('click', '.article_part_edit_btn', function() {
        ...
        $.ajax({
            url: "<?= base_url('ajax_fetch_article_part_clone') ?>",
            method: "post",
            dataType: 'json',
    ...
    $("#form_add_article_rate_clone").validate({
        rules: {
            date: {
                required: true,
                remote: {
    ...
    $('#form_add_article_rate_clone').ajaxForm({
        beforeSubmit: function () {
            return $("#form_add_article_rate_clone").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
            obj = JSON.parse(returnData);

            $('#form_add_article_rate_clone')[0].reset(); //reset form
            $("#form_add_article_rate_clone select").select2("val", ""); //reset all select2 fields
            $('#form_add_article_rate_clone :radio').iCheck('update'); //reset all iCheck fields
            $("#form_add_article_rate_clone").validate().resetForm(); //reset validation
            notification(obj);
    ...
    $("#form_edit_article_rate_clone").validate({
        rules: {
            date: {
                required: true,
                remote: {
    ...
    $('#form_edit_article_rate_clone').ajaxForm({
        beforeSubmit: function () {
            return $("#form_add_article_rate_clone").valid(); // TRUE when form is valid, FALSE will cancel submit
        },
        success: function (returnData) {
    ...
    $("#article_rate_table").on('click', '.article_rate_edit_btn', function() {
        ...
        $.ajax({
            url: "<?= base_url('ajax_fetch_article_rate_clone') ?>",
            method: "post",
            dataType: 'json',
    ...
    $(document).on('click', '.delete', function(){
        if(confirm('Are you sure?')){
            ...
            $.ajax({
                url: "<?= base_url('ajax-del-row-on-table-and-pk-clone') ?>",
                type: 'POST',
                dataType: 'json',
