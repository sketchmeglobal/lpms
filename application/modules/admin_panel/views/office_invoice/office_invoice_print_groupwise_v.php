...
if($rate_type == 1) {
   ...
   $rate_type_text = ''; 
                        ...
                        <th style="text-align: right;">Qnty in Pcs.</th>
                                        <th style="text-align: right;">Rate in <?php if(isset($print_packing_list_groupwise[0]->currency)){ ?><?=  $rate_type_text ?> / <?= $print_packing_list_groupwise[0]->currency ?> <?php } ?></th>
                                        <th style="text-align: right;">Amount in <?php if(isset($print_packing_list_groupwise[0]->currency)){ ?><?=  $rate_type_text ?> / <?= $print_packing_list_groupwise[0]->currency ?> <?php } ?></th>
                                    </tr>
                            </thead>
                        ...
                        <th style="text-align: right;">Qnty in Pcs.</th>
                            ...
                            <?php
                                    if(end($keys) == $curr_key) {
                                        ?>
                                        <tr>
                                            <td colspan="3" class="text-left"><b>Total For <?= $ppl->art_info ?></b></td>
                                            <!--<td class="text-left"></td><td class="text-left"></td>-->
                                            <td style="font-weight: bold; font-size: 14px;text-align:right" class="text-right"><?= $groups[$ppl->art_info]['gr_sum'] ?></td>
                                            <td></td>
                                            <td style="font-weight: bold; font-size: 14px;text-align:right" class="text-right"><?= $groups[$ppl->art_info]['gr_amnt'] ?></td>
...
// RoDTEP DECLARATION_DESCRIPTION IS HUGE AND CAN'T FIT HERE SO IT NEEDS SPECIAL ATTENTION
                        ...
                        ?>
                                <tr>
                            <td colspan="3" style="font-weight: bold; font-size: 12px;text-align:left; text-transform: uppercase"><h5 style="font-size: 11px;" class=""><?= $print_packing_list_groupwise[0]->currency ?> <?= convertNumberToWord(round($tot_amnt - round($tot_amnt * ($print_packing_list_groupwise[0]->discount / 100), 2), 2)) ?></h5></td>
                            <td colspan="1"  style="font-weight: bold; font-size: 14px" class="text-right"><h5 class="text-right"><?= $tot_qnty ?></h5></td>
                            <td colspan="1" style="font-weight: bold; font-size: 14px;"><h5 class=""><b>Total <?= $print_packing_list_groupwise[0]->currency ?></b></h5></td>
                        ...
                        <tr>
                            ...
                            <td colspan="1"><h5 class="" style="text-align: right"><b><?= round(($tot_amnt * ($print_packing_list_groupwise[0]->discount / 100)), 2) ?></b></h5></td>
                        </tr>
                        <tr>
                            <td colspan="2"></td>
                        ...
                        <tr>
                            ...
                            <td colspan="1"><h6 style="text-align:left;" class="">Net Total <?= $print_packing_list_groupwise[0]->currency ?></h6></td>
                            <td colspan="1"><h5 class=""  style="text-align: right"><b> <?= number_format(($tot_amnt - round($tot_amnt * ($print_packing_list_groupwise[0]->discount / 100), 2) + $print_packing_list_groupwise[0]->hand_charge), 2) ?></b></h5></td>
                        </tr>   
                            </tbody>
                        </table>
                    </div>
