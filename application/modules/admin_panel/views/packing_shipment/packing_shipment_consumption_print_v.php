                        ...
                        <table class="table table-bordered table-hover table2excel">
                            ...
                            <?php } ?>
                                    <tr>
                                        ...
                                        <td class="text-left"><?= strip_tags($ppl->alt_art_no . ' ' . $ppl->info . ' ' . $ppl->leather_color) ?></td>
                                        <td><?= $ppl->item ?></td>
                                        <td><?= $ppl->reference ?></td>
...
?>
                                <tr>
                                    <td colspan="5" style="font-weight: bold; font-size: 14px" class="text-left">Total</td>
