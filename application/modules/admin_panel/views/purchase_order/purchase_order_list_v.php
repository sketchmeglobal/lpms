            ...
            buttons: {
                ...
                printwithbrkup: {
                    ...
                    action: function(){
                        ...
                        window.open("<?= base_url() ?>admin/purchase-order-print-with-brkup/"+ $poi, "_blank");
                ...
                printwithbrkupNews: {
                    ...
                    action: function(){
                        ...
                        window.open("<?= base_url() ?>admin/purchase-order-print-with-brkup-wo-order/"+ $poi, "_blank");
    ...
    $(document).on('click', '.delete', function(){
        ...
        if(confirm('Are you sure?')){
            ...
            $.ajax({
                ...
                url: "<?= base_url('admin/ajax_fetch_purchase_order_delete_on_pk') ?>",
