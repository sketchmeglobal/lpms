...
<html lang="en">
<head>
    <title>Cutter Bill Summary | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Report - Cutter Bill Summary</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Cutter Bill Summary </li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
        ...
        <div class="wrapper">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <label>Select Cutter From The List</label><br />
