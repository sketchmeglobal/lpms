...
<html lang="en">
<head>
    <title>Stock Detail Ledger<?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Report - Stock Detail Ledger Report</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Stock Detail Ledger Report </li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
...
?>
                ...
                <br />
                <br>
                <input type="submit" name="check_stock_detail_ledger" value="Print" class="btn btn-sm btn-success col-sm-2" />
            </form>
                <br>
                        </div>
                    </section>
